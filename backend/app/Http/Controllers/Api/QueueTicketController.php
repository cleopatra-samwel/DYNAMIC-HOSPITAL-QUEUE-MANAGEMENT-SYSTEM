...
{
    private const TICKET_RELATIONS = ['priorityLevel', 'service.department', 'service.visit.patient', 'service.previousService.department', 'service.previousService.queueTicket', 'service.billingFor.department', 'service.payment'];
