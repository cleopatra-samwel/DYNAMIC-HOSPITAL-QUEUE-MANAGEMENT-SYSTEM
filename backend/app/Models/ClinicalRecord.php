...
#[Fillable([
    ...
    'final_diagnosis', 'treatment_plan', 'prescribed_medications_other', 'prescription_notes', 'dispensing_signature', 'dispensing_signed_at', 'patient_signature_name', 'patient_signature_phone', 'signed_at',
